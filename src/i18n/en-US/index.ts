  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Personal portfolio built with Quasar, Vue 3 and TypeScript; focused on performance, accessibility and responsive design, with Docker builds and continuous deployment.',
